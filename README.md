...
- 🎯 Entry points to execute your program using `python -m <kretanje_cijena>` or `$ kretanje_cijena` with basic CLI argument parsing.
...
Awesome kretanje_cijena created by brahle
...
```py
from kretanje_cijena import BaseClass
from kretanje_cijena import base_function
